			...
			className='center'>
			{
				Object.keys(discountList).map((discount,i) => {
					return <li 
							...
							<div 
								className='center' 
								style={{justifyContent: 'flex-end', alignItems:'flex-end', flexDirection: 'column', border:'1px solid grey', borderRadius:'10px', padding: '5px', margin:'10px', backgroundColor:'rgba(203, 221, 240, 1)'}}
								>
								<DiscountUpdate 
